...
// optimally , if we place the yoyos in the two opposite extreme corners of the board , the distance will 
// always be the largest possible one . Thus , the answers will be 1 , 1 and n, m. I hope this thought is correct
// for all sizes of boards . 
