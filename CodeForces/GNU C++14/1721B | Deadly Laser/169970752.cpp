...
if((sx-d>1 and sy+d<m )|| (sx + d < n and sy-d>1)) // check if the laser covers whole of the rows or coloumns and if it is not so , calaculate the shortest distance and print it .
    cout<<m+n-2<<endl;
else
    cout<<-1<<endl;
